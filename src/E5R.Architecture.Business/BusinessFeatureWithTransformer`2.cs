...
{
    /// <summary>
    /// Abstract business feature with input, output and data transformer
    /// </summary>
    /// <typeparam name="TInput">The input type</typeparam>
    /// <typeparam name="TOutput">The output type</typeparam>
    public abstract class BusinessFeatureWithTransformer<TInput, TOutput> : TransformerBasedBusinessFeature<TInput>,
        IBusinessFeatureSignature
    {
        protected BusinessFeatureWithTransformer(ILazy<ITransformationManager> transformer) : base(
            transformer)
        {
        }
