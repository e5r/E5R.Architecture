...
namespace E5R.Architecture.Business
{
    public class BusinessFacade<TFeature1, TFeature2, TFeature3, TFeature4, TFeature5, TFeature6,
        TFeature7, TFeature8, TFeature9, TFeature10> : IBusinessFacadeSignature
        ...
        where TFeature8 : IBusinessFeatureSignature
        where TFeature9 : IBusinessFeatureSignature
        where TFeature10 : IBusinessFeatureSignature
    {
        ...
        private readonly ILazy<TFeature8> _feature8;
        private readonly ILazy<TFeature9> _feature9;
        private readonly ILazy<TFeature10> _feature10;
        ...
        public BusinessFacade(ILazy<TFeature1> feature1, ILazy<TFeature2> feature2,
            ...
            ILazy<TFeature6> feature6, ILazy<TFeature7> feature7, ILazy<TFeature8> feature8,
            ILazy<TFeature9> feature9, ILazy<TFeature10> feature10)
        {
            ...
            Checker.NotNullArgument(feature8, nameof(feature8));
            Checker.NotNullArgument(feature9, nameof(feature9));
            Checker.NotNullArgument(feature10, nameof(feature10));
        ...
        protected TFeature8 Feature8 => _feature8.Value;
        protected TFeature9 Feature9 => _feature9.Value;
        protected TFeature10 Feature10 => _feature10.Value;
    }
}
