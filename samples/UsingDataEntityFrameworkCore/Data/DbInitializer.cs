...
namespace UsingDataEntityFrameworkCore.Data
{
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            foreach (var student in new Student[]
            {
                new Student{FirstMidName="Erlimar", LastName="Silva Campos",EnrollmentDate=DateTime.Parse("2020-10-06")},
            ...
            foreach (var course in new Course[]{
            ...
            foreach (var enrollment in new Enrollment[]{
                ...
                new Enrollment{StudentID=8,CourseID=1050},
            })
            {
