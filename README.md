...
Leia as [notas de lançamento ](docs/release-notes.md) para saber das últimas novidades,
ou se preferir, pode acompanhar a documentação oficial [aqui](https://e5r.github.io/E5R.Architecture).
